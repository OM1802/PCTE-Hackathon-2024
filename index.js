...
<div class='col-md-12 col-lg-3 mt-1' id=${id} key=${id}>
<div class='card shadow-sm task__card effect2'">
  ...
  ${
    ...
    ` :
    `<img hidden width = '100%' height="200px" src ="https://www.jennybeaumont.com/wp-content/uploads/2015/03/placeholder.gif" alt = 'card image cap' class = 'card-image-top md-3 rounded-lg'/> `
  }
...
<span class="dates"><strong class = 'text-sm text-muted'>Created on ${date.toDateString()}</strong></span>
